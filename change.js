    ...
    update: function () {
        ...
        if (Phaser.Input.Keyboard.JustDown(keyD)) {
            if (!this.DCD) {
                ...
                this.DCD = true;
                this.time.addEvent({ delay: 300, callback: this.resetDCD, callbackScope: this });
            } else {
                this.buttonD.play('releaseD', true);
            }
        }
        if (Phaser.Input.Keyboard.JustDown(keyF)) {
            if (!this.FCD) {
                ...
                this.FCD = true;
                this.time.addEvent({ delay: 300, callback: this.resetFCD, callbackScope: this });
            } else {
                this.buttonF.play('releaseF', true);
            }
        }
        if (Phaser.Input.Keyboard.JustDown(keyJ)) {
            if (!this.JCD) {
                ...
                this.JCD = true;
                this.time.addEvent({ delay: 300, callback: this.resetJCD, callbackScope: this });
            } else {
                this.buttonF.play('releaseJ', true);
            }
        }
        if (Phaser.Input.Keyboard.JustDown(keyK)) {
            if (!this.JCD) {
                ...
                this.KCD = true;
                this.time.addEvent({ delay: 300, callback: this.resetKCD, callbackScope: this });
            } else {
                this.buttonF.play('releaseK', true);
            }
        }
